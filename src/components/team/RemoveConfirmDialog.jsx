...
const RemoveConfirmDialog = ({ isOpen, member, onClose, onConfirm, isSubmitting }) => {
            ...
            <div className="relative bg-[#161B28] border border-[#2D3748] rounded-2xl w-full max-w-[450px] shadow-2xl animate-in">
                <div className="p-lg">
                    <div className="w-12 h-12 rounded-full bg-[#EF4444]/10 flex items-center justify-center mb-md border border-[#EF4444]/20">
                        <span className="material-symbols-outlined text-[#EF4444] text-[24px]">person_remove</span>
                    </div>
                    ...
                    <p className="font-body-md text-on-surface-variant leading-relaxed">
                        Are you sure you want to remove <strong className="text-on-surface">{member.full_name || member.email}</strong> from the workspace? 
